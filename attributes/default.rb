...
default['maven']['maveneventspyclient_sorce'] = 'http://nexus.wdf.sap.corp:8081/nexus/content/repositories/build.milestones/com/sap/prd/BuildCounterSlave/BuildCounterSlave/0.0.1/BuildCounterSlave-0.0.1.jar'
